...
- **Rich Control Suite:**
  ...
  - **Button:** Supports retro-computing DOS-era control aesthetics via `ButtonShadowStyle`, exposing dependency properties (`ShadowStyle`, `ShadowForeground`, `ShadowBackground`, `ShadowOffsetX`, `ShadowOffsetY`) that facilitate vintage visual depth while operating seamlessly within modern hierarchical binding contexts.
