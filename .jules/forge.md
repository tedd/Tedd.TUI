...
**Observation:** The TUI framework lacked a native `Thumb` control primitive, which is necessary for establishing draggable and resizable interactions (such as ScrollBars and GridSplitters). Standard implementations utilized ad-hoc logic per-component, preventing standardized drag event routing.
**Strategic Action:**
