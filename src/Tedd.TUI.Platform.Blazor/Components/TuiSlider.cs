...
public class TuiSlider : TuiComponentBase
{
    ...
    [Parameter] public ConsoleColor TrackColor { get; set; } = ConsoleColor.DarkGray;
    [Parameter] public ConsoleColor ThumbColor { get; set; } = ConsoleColor.White;
    [Parameter] public ConsoleColor FocusedThumbColor { get; set; } = ConsoleColor.Yellow;
    ...
    protected override void ApplyProperties()
    {
        ...
        _slider.TrackColor = TrackColor;
        _slider.ThumbColor = ThumbColor;
        _slider.FocusedThumbColor = FocusedThumbColor;
    }
}
