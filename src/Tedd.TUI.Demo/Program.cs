...
class Program
{
    ...
    static void RunCodeDemo()
    {
        ...
        // ToggleButton
        formStack.AddChild(new TextBlock { Text = "Toggle Buttons:" });
        var toggleGroup = new StackPanel { Orientation = Orientation.Horizontal };
        toggleGroup.AddChild(new ToggleButton { Content = "Standard Toggle" });
        toggleGroup.AddChild(new ToggleButton { Content = "Three-State Toggle", IsThreeState = true, IsChecked = null });
        formStack.AddChild(toggleGroup);
